 ...
 * @author Huzzu
 */
public class View_Beautician extends javax.swing.JFrame {

   Connection con=null;
    Statement st;
    ResultSet rs;
    public View_Beautician() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Find User Female_751px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 70)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 102, 102));
        jLabel2.setText("VIEW BEAUTICIAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Beautician.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Beautician().setVisible(true);
            }
        });
    }
